package com.example.crud_mahasiswa_berita.adapter
...
import com.example.crud_mahasiswa_berita.DetailMhsActivity
...
) : ListAdapter<ModelMahasiswa, UserAdapter.MahasiwaViewHolder>(MahasiswaCallBack) {
...
//                .into(imgBerita)
    ...
    override fun onBindViewHolder(holder: MahasiwaViewHolder, position: Int) {
        ...
        holder.cardMahasiswa.setOnClickListener {
            val intent = Intent(holder.itemView.context, DetailMhsActivity::class.java)
